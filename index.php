...
<body style="background-color: #0f4881;color: WHITE">
		<h1>CATALOGO DE PRODUCTOS TARAMICH </h1>
		      <h2>PRODUCTOS</h2>
...
<script type="text/javascript">
	$(document).ready(function(){//la funcion del menu
		$(".gridder").gridderExpander({
			scroll: true,
			scrollOffset: 60,
                    scrollTo: "listitem", // panel or listitem
                    animationSpeed: 100, //tiempo
